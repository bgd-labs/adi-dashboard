    ...
    <div className="flex shrink-0 items-center gap-2 text-sm">
      ...
      <span className="font-semibold">
        {isLoading ? (
          ...
          <span className="flex h-6 w-6 items-center justify-center rounded-full bg-brand-900 pt-[1px] font-mono leading-none text-white">
            {bandwidth}
          </span>
        )}
      </span>
